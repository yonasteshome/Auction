    ...
    return (
      <div className="flex flex-col gap-3">
        ...
        <Popover open={open} onOpenChange={setOpen}>
          <PopoverTrigger render={<Button variant="outline" id="date" className="w-48 justify-between font-normal" />}>{date ? date.toLocaleDateString() : "Select date"}<ChevronDownIcon /></PopoverTrigger>
    ...
    return (
      <div className="flex flex-col gap-3">
        ...
        <div className="relative flex gap-2">
          ...
          />
          <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger render={<Button id="date-picker" variant="ghost" className="absolute top-1/2 right-2 size-6 -translate-y-1/2" />}><CalendarIcon className="size-3.5" /><span className="sr-only">Select date</span></PopoverTrigger>
            <PopoverContent
    ...
    return (
      <div className="flex gap-4">
        <div className="flex flex-col gap-3">
          ...
          <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger render={<Button variant="outline" id="date-picker" className="w-32 justify-between font-normal" />}>{date ? date.toLocaleDateString() : "Select date"}<ChevronDownIcon /></PopoverTrigger>
            <PopoverContent
              className="w-auto overflow-hidden p-0"
              align="start"
            >
